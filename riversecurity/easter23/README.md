...
I usually started each of these tasks with BurpSuite Intruder where I send a one-character payload and filter for the string "Illegal character discovered" to see what is blocked this time:
